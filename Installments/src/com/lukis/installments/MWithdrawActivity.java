...
public class MWithdrawActivity extends Activity {
	...
	protected void onResume() {
		...
		table = (TableLayout) MWithdrawActivity.this
		...
		v.setOnTouchListener(new OnSwipeTouchListener() {
			public void onSwipeRight() {
				...
				Toast.makeText(MWithdrawActivity.this, "Previous month",
			...
			public void onSwipeLeft() {
				monthNumber++;
				// eDate.setText("dzień dobry "+dateNumber);
				Toast.makeText(MWithdrawActivity.this, "Next month",
						Toast.LENGTH_SHORT).show();
	...
	public void refresh() {
		if (dlugosc > 0) {
			...
			for (int i = 0; i < dlugosc; i++) {
				...
				if (lista[i][2].contains("" + searchDate) || sumAll ) {
					...
					TableRow row = (TableRow) LayoutInflater.from(
							MWithdrawActivity.this).inflate(
			...
			if (sumAll) {
				eInfo.setText("M Withdrawals: Total");
			} else if (sumYear) {
				eInfo.setText("M Withdrawals: "
	...
	public void addExp(View view) {
		...
		Intent intent = new Intent(MWithdrawActivity.this,
