...
public class GenExpensesActivity extends Activity {
	...
	protected void onResume() {
		...
		table = (TableLayout) GenExpensesActivity.this
		...
		v.setOnTouchListener(new OnSwipeTouchListener() {
			public void onSwipeRight() {
				...
				Toast.makeText(GenExpensesActivity.this, "Previous month",
			...
			public void onSwipeLeft() {
				monthNumber++;
				// eDate.setText("dzień dobry "+dateNumber);
				Toast.makeText(GenExpensesActivity.this, "Next month",
						Toast.LENGTH_SHORT).show();
	...
	public void refresh() {
		if (dlugosc > 0) {
			...
			if (sumAll) {
				eInfo.setText("General Expenses: Total");
			} else if (sumYear) {
				eInfo.setText("General Expenses: "
	...
	public void addExp(View view) {
		...
		Intent intent = new Intent(GenExpensesActivity.this,
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.gen_expenses, menu);
		return true;
	}
