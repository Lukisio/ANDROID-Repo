...
public class ADepositActivity extends Activity {
	...
	public static String urlExpDate = "http://united.webege.com/generator.php?table=expense";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_adeposit);
	...
	protected void onResume() {
		...
		table = (TableLayout) ADepositActivity.this
		...
		v.setOnTouchListener(new OnSwipeTouchListener() {
			public void onSwipeRight() {
				...
				Toast.makeText(ADepositActivity.this, "Previous month",
			...
			public void onSwipeLeft() {
				monthNumber++;
				// eDate.setText("dzień dobry "+dateNumber);
				Toast.makeText(ADepositActivity.this, "Next month",
						Toast.LENGTH_SHORT).show();
	...
	public void refresh() {
		if (dlugosc > 0) {
			...
			if (sumAll) {
				eInfo.setText("A Deposit: Total");
			} else if (sumYear) {
				eInfo.setText("A Deposit: "
	...
	public void addExp(View view) {
		...
		Intent intent = new Intent(ADepositActivity.this,
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.adeposit, menu);
		return true;
	}
