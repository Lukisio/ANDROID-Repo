...
public class ADepositActivity extends Activity {
    ...
    protected void onResume(){
		...
		table = (TableLayout)ADepositActivity.this.findViewById(R.id.tableLayout);
		...
		{		
		    ...
		    TableRow row = (TableRow)LayoutInflater.from(ADepositActivity.this).inflate(R.layout.expense_row, null);
 ...
 //	  kreciolek.setVisibility(View.VISIBLE);
  ...
  //  info.setText(""+progress[0]);
    ...
    public void addExp(View view){
    	...
    	Intent intent = new Intent(ADepositActivity.this, NewExpenseActivity.class);
