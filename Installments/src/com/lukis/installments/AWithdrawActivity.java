...
public class AWithdrawActivity extends Activity {
	...
	protected void onResume() {
		...
		table = (TableLayout) AWithdrawActivity.this
		...
		v.setOnTouchListener(new OnSwipeTouchListener() {
			public void onSwipeRight() {
				...
				Toast.makeText(AWithdrawActivity.this, "Previous month",
			...
			public void onSwipeLeft() {
				monthNumber++;
				// eDate.setText("dzień dobry "+dateNumber);
				Toast.makeText(AWithdrawActivity.this, "Next month",
						Toast.LENGTH_SHORT).show();
	...
	public void refresh() {
		if (dlugosc > 0) {
			...
			if (sumAll) {
				eInfo.setText("A Withdrawals: Total");
			} else if (sumYear) {
				eInfo.setText("A Withdrawals: "
	...
	public void addExp(View view) {
		...
		Intent intent = new Intent(AWithdrawActivity.this,
