...
import com.example.feedercall.OknoGlowne.KlasaDetal;
...
public class ObslugaJSON {
	...
	public static void zapisz(KlasaDetal detal) {
		InputStream isZ = null;
		String pelnyAdres=OknoGlowne.urlZapis;
